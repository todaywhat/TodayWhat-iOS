...
public struct SchoolSettingView: View {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 34) {
                    if !viewStore.isFocusedSchool {
                        ...
                        classTextField(viewStore: viewStore)
                        gradeTextField(viewStore: viewStore)
                    }
    ...
    @ViewBuilder
    private func headerSection(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
        HStack {
    ...
    @ViewBuilder
    private func majorTextField(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
        if !viewStore.class.isEmpty && !viewStore.schoolMajorList.isEmpty {
            VStack {
                TWTextField(
                    "학과",
    ...
    @ViewBuilder
    private func classTextField(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
    ...
    @ViewBuilder
    private func gradeTextField(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
    ...
    @ViewBuilder
    private func schoolTextField(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
        TWTextField(
            "학교이름",
            text: viewStore.binding(
                get: \.school,
    ...
    @ViewBuilder
    private func schoolSearchResults(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
        if viewStore.isFocusedSchool {
    ...
    @ViewBuilder
    private func nextButton(viewStore: ViewStoreOf<SchoolSettingCore>) -> some View {
    ...
    private var majorSheet: some View {
        IfLetStore(
